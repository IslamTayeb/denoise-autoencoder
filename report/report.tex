...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.68\linewidth]{exp_3_arch/training_curves.png}
...
\end{subfigure}
\caption{Two views of real-data behavior for \texttt{Influenza}. The top panel matches the synthetic task closely. The bottom panel shows the harder raw-series setting.}
\label{fig:real}
\end{figure}
